...
void loop() {
  ...
  if(millis() - timer > 200){
    ...
    point_avg.x = (point[0].x2 + point[1].x2 + point[2].x2 )/3;
    point_avg.y = (point[0].y2 + point[1].y2 + point[3].y2 )/3;
